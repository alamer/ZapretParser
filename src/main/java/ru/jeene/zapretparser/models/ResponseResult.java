...
public enum ResponseResult {
    ...
    TIMEOUT(3, "Timeout"),
    SOCKET_EXCEPTION(4,"Unexpected end of file from server"),
    PROTOCOL_EXCEPTION(5,"Server redirected too many  times"),
    SSLPROTOCOL_EXCEPTION(6,"no more data allowed for version 1 certificate"),
    SSLHANDSHAKE_EXCEPTION(7,"Received fatal alert: handshake_failure"),
